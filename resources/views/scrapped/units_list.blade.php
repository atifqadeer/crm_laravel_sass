                        ...
                        <div class="text-md-end mt-3">
                            ...
                            <div class="dropdown d-inline">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item export-btn" href="{{ route('unitsExport', ['type' => 'scrapped-all']) }}">Export All Data</a>
                                    @endcanany
                                    @canany(['unit-export-emails'])
                                    <a class="dropdown-item export-btn" href="{{ route('unitsExport', ['type' => 'scrapped-emails']) }}">Export Emails</a>
                                    @endcanany
                                </div>
                            </div>
                            @endcanany
        ...
        function deleteUnit(id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('scrapped.unit.destroy', ':id') }}".replace(':id', id),
                            type: 'DELETE',
                            data: {
