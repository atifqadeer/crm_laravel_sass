<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="chatOffcanvas" style="width: 20%; height: 700px;">
  <div class="offcanvas-header bg-primary text-white">
    <div class="d-flex align-items-center">
      <img src="{{ asset('images/users/boy.png') ?? asset('images/users/default.jpg') }}" class="rounded-circle me-2" width="40" height="40" id="chatUserAvatar">
      <div>
    ...
    <div class="border-top p-3 bg-white">
      <form id="messageForm">
        ...
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Type your message..." id="messageInput" required>
