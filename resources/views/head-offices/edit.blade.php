                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="1" {{ old('status', $office->status == "1" ? 'selected':'') }}>Active</option>
                                        <option value="0" {{ old('status', $office->status == "0" ? 'selected':'') }}>Inactive</option>
                                        <option value="4" {{ old('status', $office->status == "4" ? 'selected':'') }}>Scrapped</option>
                                    </select>
                                    <div class="invalid-feedback">Please select type</div>
                                </div>
                            </div>
