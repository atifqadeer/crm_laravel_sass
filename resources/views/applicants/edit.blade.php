...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <form id="editApplicantForm" action="{{ route('applicants.update') }}" method="POST" class="needs-validation"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select class="form-select" id="job_category" name="job_category_id" required>
                                        ...
                                        @foreach ($jobCategories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('job_category_id', $applicant->job_category_id == $category->id ? 'selected' : '') }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="job_type" name="job_type" required>
                                        ...
                                        <option value="specialist"
                                            {{ old('job_type', $applicant->job_type == 'specialist' ? 'selected' : '') }}>
                                            Specialist</option>
                                        <option value="regular"
                                            {{ old('job_type', $applicant->job_type == 'regular' ? 'selected' : '') }}>
                                            Regular
                                        </option>
                                    </select>
                                    ...
                                    <select class="form-select" id="job_source" name="job_source_id" required>
                                        ...
                                        @foreach ($jobSources as $source)
                                            <option value="{{ $source->id }}"
                                                {{ old('job_source_id', $applicant->job_source_id == $source->id ? 'selected' : '') }}>
                                                {{ $source->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="applicant_name" class="form-control" name="applicant_name"
                                        ...
                                        @cannot('applicant-edit-name') readonly @endcannot placeholder="Full Name" required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="gender" name="gender" required>
                                        ...
                                        <option value="m"
                                            {{ old('gender', $applicant->gender == 'm' ? 'selected' : '') }}>Male</option>
                                        <option value="f"
                                            {{ old('gender', $applicant->gender == 'f' ? 'selected' : '') }}>Female
                                        </option>
                                        <option value="u"
                                            {{ old('gender', $applicant->gender == 'u' ? 'selected' : '') }}>Unknown
                                        </option>
                                    </select>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <label for="applicant_email_primary" class="form-label">Email <small
                                            class="text-info">(Primary)</small></label>
                                    <input type="email" id="applicant_email_primary" class="form-control"
                                        name="applicant_email"
                                        value="{{ old('applicant_email', $applicant->applicant_email) }}"
                                        @cannot('applicant-edit-email') readonly @endcannot placeholder="Enter Email"
                                        required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <label for="applicant_email_secondary" class="form-label">Email <small
                                            class="text-info">(Secondary)</small></label>
                                    <input type="email" id="applicant_email_secondary" class="form-control"
                                        @cannot('applicant-edit-email') readonly @endcannot
                                        name="applicant_email_secondary"
                                        value="{{ old('applicant_email_secondary', $applicant->applicant_email_secondary) }}"
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    <label for="applicant_postcode" class="form-label">PostCode <small
                                            class="text-info">(If unavailable, use the last workplace
                                            postcode.)</small></label>
                                    <input type="text" id="applicant_postcode" class="form-control"
                                        @cannot('applicant-edit-postcode') readonly @endcannot
                                        value="{{ old('applicant_postcode', $applicant->applicant_postcode) }}"
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    <label for="applicant_phone" class="form-label">Phone <small
                                            class="text-info">(Primary)</small></label>
                                    <input type="tel" id="applicant_phone" class="form-control"
                                        name="applicant_phone"
                                        value="{{ old('applicant_phone', $applicant->applicant_phone) }}"
                                        @cannot('applicant-edit-phone') readonly @endcannot
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    <label for="applicant_phone_secondary" class="form-label">Phone <small
                                            class="text-info">(Secondary)</small></label>
                                    <input type="tel" id="applicant_phone_secondary" class="form-control"
                                        name="applicant_phone_secondary"
                                        value="{{ old('applicant_phone_secondary', $applicant->applicant_phone_secondary) }}"
                                        @cannot('applicant-edit-phone') readonly @endcannot
                                        placeholder="Enter Phone Number" required>
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" id="applicant_landline" class="form-control"
                                        @cannot('applicant-edit-landline') readonly @endcannot
                                        value="{{ old('applicant_landline', $applicant->applicant_landline) }}"
                                        name="applicant_landline" placeholder="Enter Landline Number">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="applicant_experience" name="applicant_experience" rows="7"
                                        placeholder="Enter Experience">{{ old('applicant_experience', $applicant->applicant_experience) }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-12" id="nurseToggleContainer" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <p class="text-muted">Please indicate if the applicant has prior experience working in
                                        a nursing home.</p>
                                    <small class="text-info">This information helps us better understand the applicant's
                                        background.</small>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            name="have_nursing_home_experience" id="nurse_option_yes" value="1"
                                            required
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            name="have_nursing_home_experience" id="nurse_option_no" value="0"
                                            required
