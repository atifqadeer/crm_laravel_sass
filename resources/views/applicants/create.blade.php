                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="applicant_name" class="form-control" name="applicant_name"
                                        value="{{ old('applicant_name') }}" placeholder="Full Name" required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="applicant_email_primary" value="{{ old('applicant_email') }}"
                                        class="form-control" name="applicant_email" placeholder="Enter Email" required>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="applicant_email_secondary" class="form-control"
                                        name="applicant_email_secondary" value="{{ old('applicant_email_secondary') }}"
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="applicant_postcode" class="form-control"
                                        value="{{ old('applicant_postcode') }}" name="applicant_postcode"
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" id="applicant_phone" class="form-control"
                                        name="applicant_phone" value="{{ old('applicant_phone') }}"
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" id="applicant_phone_secondary" class="form-control"
                                        name="applicant_phone_secondary" value="{{ old('applicant_phone_secondary') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                            ...
                                            {{ old('have_nursing_home_experience') == '1' ? 'checked' : '' }} required>
