                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="job_source_id" name="job_source_id">
                                        ...
                                        @forelse($jobSources as $source)
                                            <option value="{{ $source->id }}" {{ old('job_source_id', $sale->job_source_id == $source->id ? 'selected' : '') }}>{{ $source->name }}
                                            </option>
                                        @empty
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="cv_limit" class="form-control" name="cv_limit"
                                    value="{{ old('cv_limit', $sale->cv_limit) }}" placeholder="Enter CV Limit" required>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="1" {{ old('status', $sale->status == "1" ? 'selected' : '') }}>Open
                                        </option>
                                        <option value="0" {{ old('status', $sale->status == "0" ? 'selected' : '') }}>Closed
                                        </option>
                                        <option value="2" {{ old('status', $sale->status == "2" ? 'selected' : '') }}>Pending
                                        </option>
                                        <option value="3" {{ old('status', $sale->status == "3" ? 'selected' : '') }}>Rejected
                                        </option>
                                        <option value="4" {{ old('status', $sale->status == "4" ? 'selected' : '') }}>Scrapped
                                        </option>
                                    </select>
