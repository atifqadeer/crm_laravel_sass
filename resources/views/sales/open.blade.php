                        ...
                        <div class="text-md-end mt-3">
                            ...
                            <div class="dropdown d-inline">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                    <a class="dropdown-item" href="{{ route('salesExport', ['type' => 'allOpen']) }}">Export All Data</a>
                                    <a class="dropdown-item" href="{{ route('salesExport', ['type' => 'emailsOpen']) }}">Export Emails</a>
                                </div>
                            </div>
                    </div><!-- end col-->
                </div>
            ...
            var table = $('#sales_table').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    if (pageInfo.recordsTotal === 0) {
                        $('#sales_table tbody').html('<tr><td colspan="16" class="text-center">Data not found</td></tr>');
                    } else {
