                            ...
                            <div class="text-md-end mt-3">
                                ...
                                <div class="dropdown d-inline">
                                    <button class="btn btn-outline-primary me-1 my-1 dropdown-toggle" type="button"
                                        id="dateFlockDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="dropdown d-inline">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                        <a class="dropdown-item export-btn"
                                            href="{{ route('salesExport', ['type' => 'allOpen']) }}">Export All Data</a>
                                        <a class="dropdown-item export-btn"
                                            href="{{ route('salesExport', ['type' => 'emailsOpen']) }}">Export Emails</a>
                                    </div>
                                </div>
                            </div><!-- end col-->
                        </div>
                ...
                var table = $('#sales_table').DataTable({
                    ...
                    ajax: {
                        ...
                        data: function(d) {
                            ...
                            d.date_flock_filter =
                            currentDateFlockFilter; // Send the current filter value as a parameter
                            d.category_filter =
