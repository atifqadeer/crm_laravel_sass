                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernotee" id="experience" name="experience" rows="3"
                                        placeholder="Enter Experience">{{ old('experience') }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernotee" id="benefits" name="benefits" rows="3"
                                        placeholder="Enter Benefits" required>{{ old('benefits') }}</textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernotee" id="qualification" name="qualification" rows="3"
                                        placeholder="Enter Qualification" required>{{ old('qualification') }}</textarea>
