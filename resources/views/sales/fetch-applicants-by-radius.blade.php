                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <ul class="list-unstyled mb-0">
                                ...
                                <li><strong>Qualification:</strong>
                                    <x-summernote-display
                                        :html="$sale->qualification"
                                        :id="'qualification-' . $sale->id"
                                        label="Sale Qualification"
                                    />
                                </li>
                        ...
                        <div class="col-md-6 mb-3">
                            <ul class="list-unstyled mb-0">
                                ...
                                <li><strong>Salary:</strong> {{ $sale->salary ?: 'N/A' }}</li>
                                ...
                                <li><strong>Experience:</strong>
                                    <x-summernote-display
                                        :html="$sale->experience"
                                        :id="'experience-' . $sale->id"
                                        label="Sale Experience"
                                    />
                                </li>
                                ...
                                <li class="mt-1">
                                    {{-- Job Description modal trigger --}}
                                    @php $jdId = 'job-description-' . $sale->id; @endphp
                                    <a href="#" class="btn btn-info btn-sm my-1"
                                       data-bs-toggle="modal" data-bs-target="#{{ $jdId }}">
                                        <span class="nav-icon">
                                    ...
                                    {{-- Render the full Summernote HTML in a modal --}}
                                    <x-summernote-display
                                        :html="$sale->job_description"
                                        :id="$jdId"
