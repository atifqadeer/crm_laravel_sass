...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            loadingRow.innerHTML = `<td colspan="15" class="text-center py-4">
            ...
            var table = $('#applicants_table').DataTable({
                ...
                drawCallback: function(settings) {
                    let saleId = settings.json?.sale_id;
                    if (saleId) {
                        $('#sale_id').val(saleId);
                    }
                    ...
                    if (pageInfo.recordsTotal === 0) {
                        $('#applicants_table tbody').html('<tr><td colspan="15" class="text-center">Data not found</td></tr>');
                    } else {
