            ...
            return DataTables::eloquent($model)
                ...
                ->addColumn('action', function ($applicant) use ($statusFilter) {
                    ...
                    switch ($statusFilter) {
                        case 'active cvs':
                            if (Gate::allows('quality-assurance-resource-clear-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"cleared\", \"Mark Clear CV\")'>Mark Clear CV</a></li>";
                            }
                            if (Gate::allows('quality-assurance-resource-reject-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"rejected\", \"Mark Reject CV\")'>Mark Reject CV</a></li>";
                            }
                            if (Gate::allows('quality-assurance-resource-open-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"opened\", \"Mark Open CV\")'>Mark Open CV</a></li>";
                            }
                            break;
                        case 'open cvs':
                            if (Gate::allows('quality-assurance-resource-revert-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ",\"revert\", \"Mark Revert CV\")'>Mark Revert CV</a></li>";
                            }
                            if (Gate::allows('quality-assurance-resource-reject-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ",\"rejected\", \"Mark Reject CV\")'>Mark Reject CV</a></li>";
                            }
                        ...
                        case 'no job cvs':
                            if (Gate::allows('quality-assurance-resource-clear-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"cleared_no_job\", \"Mark Clear CV\")'>Mark Clear CV</a></li>";
                            }
                            if (Gate::allows('quality-assurance-resource-reject-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"rejected\", \"Mark Reject CV\")'>Mark Reject CV</a></li>";
                            }
                        ...
                        case 'rejected cvs':
                            if (Gate::allows('quality-assurance-resource-revert-cv')) {
                                $html .= "<li><a class='dropdown-item' href='javascript:void(0);' onclick='clearCVModal(" . (int)$applicant->id . ", " . (int)$applicant->sale_id . ", \"revert\", \"Mark Revert As Active\")'>Mark Revert As Active</a></li>";
                            }
                            break;
                        case 'cleared cvs':
                            $html .= "";
